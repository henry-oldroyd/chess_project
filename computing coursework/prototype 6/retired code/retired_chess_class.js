...
function promise_factory(event_name) {
    // returns a promise
    async function external_get_response() {
        ...
        let result = await server_response_promise
...
// define async function to make request to server
external_get_computers_move = promise_factory("get_computer_move");
external_get_legal_moves = promise_factory("get_legal_moves");
external_get_pieces_matrix = promise_factory("get_pieces_matrix");
external_get_game_over = promise_factory("get_game_over");
...
class Chess_Board {
    ...
    make_user_move(from_vector, to_vector) {
        ...
        [from_vector, to_vector] = computer_move;
